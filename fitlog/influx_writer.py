...
class InfluxWriter:
    ...
    def create_point(self, measurement: str, value: float, 
                    timestamp: int, tags: Optional[Dict] = None, 
                    fields: Optional[Dict] = None) -> Point:
    ...
    def write_steps_data(self, steps_data: List[Dict]) -> int:
        ...
        return self.write_health_data([
            {'measurement': 'steps', 'value': item['value'], 'timestamp': item['timestamp']}
    ...
    def write_weight_data(self, weight_data: List[Dict]) -> int:
        """Write weight data"""
        return self.write_health_data([
            {'measurement': 'weight', 'value': item['value'], 'timestamp': item['timestamp']}
    ...
    def write_calories_data(self, calories_data: List[Dict]) -> int:
        """Write calories data"""
        return self.write_health_data([
            {'measurement': 'calories', 'value': item['value'], 'timestamp': item['timestamp']}
    ...
    def write_heart_rate_data(self, heart_rate_data: List[Dict]) -> int:
        ...
        return self.write_health_data([
            {'measurement': 'heart_rate', 'value': item['value'], 'timestamp': item['timestamp']}
